...
namespace Sewing.Controllers
{
    ...
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(SewingContext context, CachedService cachedService)
        {
            _context = context;
        ...
        public async Task<ActionResult<IEnumerable<Employee>>> GetEmployees([FromQuery] int page = 1)
        {
            ...
            return View("Get", new DataViewModel<Employee>()
            {
                Data = _cachedService.GetEmployee(page,_size),
